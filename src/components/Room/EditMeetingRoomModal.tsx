...
const EditNewCompany = ({rec,onEditSuccess}:any) => {
    ...
    return (
        <>
            ...
            <Modal
                title={
                    <div className={styles.formTitle}>Edit Meeting Room</div>
                }
                open={visible}
            ...
            >
                ...
                >
                    ...
                    <Form.Item
                            label={<span className={styles.label}>Upload Meeting Room Image</span>}
                            name="upload"
                            style={{width: '100%'}}
                        >              
                    ...
                    <div className={styles.formControl}>
                            <form id="form-file-upload" className={styles.formupload} onDragEnter={handleDrag} onSubmit={(e) => e.preventDefault()}>
                                ...
                                <label id="label-file-upload" htmlFor="input-file-upload" className={`${styles.fileupload} ${dragActive ? "drag-active" : ""}`}>
                                    <div>
                                    <svg xmlns="http://www.w3.org/2000/svg" width="58" height="50" viewBox="0 0 58 50" fill="none" style={{ marginLeft:'38%', marginBottom:'10px' }}>
                                    <path d="M28.9999 37.011H14.7519C7.89325 37.0003 2.33325 31.6483 2.33325 25.0457C2.33325 18.4457 7.89325 13.0937 14.7519 13.0937C15.7999 8.39501 19.5359 4.56034 24.5519 3.03234C29.5652 1.50701 35.1012 2.51768 39.0692 5.69901C43.0372 8.87234 44.8346 13.7177 43.7892 18.4163H46.4292C50.1092 18.4163 53.2826 20.579 54.7706 23.7123M47.6666 47.667V31.667M47.6666 31.667L55.6666 39.667M47.6666 31.667L39.6666 39.667" stroke="#225560" stroke-width="4" stroke-linecap="round" stroke-linejoin="round"/>
                                    </svg>
                                ...
                                {apiImagePreview && (
                                    <div>
                                        <img
                                            ...
                                            style={{ width: '500px', height: '225px', marginTop:'10px', marginBottom:'10px', marginLeft:'100px' }}
                                        />
