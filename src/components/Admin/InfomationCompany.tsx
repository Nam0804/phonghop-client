...
const InfomationCompany = ({rec}:any) => {
    ...
    return (
        <>
            <button key="view" className={customstyle.custombutton} onClick={showPopup}><img src="/eye.svg"></img></button>
            <Modal
                title={
                    <div className={styles.formTitle}>View Company Infomation</div>
                }
                open={visible}
                ...
                >
                    <div className={styles.formControl}>
                        <Form3.Item
                            ...
                            style={{width: '100%'}}
                        >
                            <input className={`${styles.Input} ${styles.customInput}`} disabled={true} readOnly/>
                        </Form3.Item>
                    ...
                    <div className={styles.formControl}>
                        <Form3.Item
                            ...
                            style={{width: '100%'}}
                        >
                            <input className={`${styles.Input} ${styles.customInput}`} disabled={true}/>
                        </Form3.Item>
                    ...
                    <div className={styles.buttonsingle}>
                        <button color="#FFF" className={styles.buttonClose} onClick={handleCancel}>CLOSE</button>
                    </div>
                </Form3>
            </Modal>
        </>
