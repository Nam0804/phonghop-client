...
import {Modal,Input,Row,Col,Form,Card,Image,Layout,List,Skeleton,Avatar,Select,} from "antd";
        ...
        {/* =================== */}
          ...
          <div className={styles.buttonContainer}>
              ...
              <Button
                ...
                label="DELETE"
              />
              <BookingDelete booking_id={rec.id} open={deleteConfirmationVisible} cancel={(data:any) => {
                handleCancel();
                setDeleteConfirmationVisible(false)
                fetchBooking();
              }} onDeleteSuccess={handleDeleteSuccess}></BookingDelete>
              <Button
                className={styles.buttonClose}
