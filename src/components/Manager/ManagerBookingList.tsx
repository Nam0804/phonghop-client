    ...
    const columns: ColumnsType<DataType> = [
        ...
        },
        {
            ...
            render: (_, record) => {
                return (
                    <Space size="middle">
                        <button className={styles.confirmAgreeButton}
                                style={{backgroundColor: getBtnColor(record.register_status, 'confirm')}}
                                onClick={() => handletestButtonClick(record.id, 1)}>
                            <svg xmlns="http://www.w3.org/2000/svg" width="18" height="14" viewBox="0 0 18 14"
                                 fill="none">
                                <path d="M1.125 7.375L6.375 12.625L16.875 1.375" stroke="white" stroke-width="2"
                                      stroke-linecap="round" stroke-linejoin="round"/>
                            </svg>
                        </button>
                        <button className={styles.confirmDisagreeButton}
                                style={{backgroundColor: getBtnColor(record.register_status, 'decline')}}
        ...
        },
        {
            ...
            render: (_, record) => (
                <Space size="middle">
                    ...
                    <button key="delete" className={styles.custombutton} style={{backgroundColor: '#E56353'}}><img
                        src="/delete.svg"></img></button>
                </Space>
            ),
            fixed: 'right',
            width: 191,
