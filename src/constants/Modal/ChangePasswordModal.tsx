    ...
    <Modal title={title} onClose={closeModal} width="975">
      {
          ...
          <div className={styles.inputgroup}>
              <div className={styles.inputform1} style={{marginBottom:'35px'}}>
                  ...
                  <input type={currentPasswordVisible ? 'text' : 'password'} name="password" placeholder="Password" className={customstyles.inputsection} value={currentPassword} onChange={(e) => setCurrentPassword(e.target.value)}/>
              ...
              <div className={styles.inputform1} style={{marginBottom:'35px'}}>
                  ...
                  <img src="/pass.svg" alt="" className={customstyles.icon}/>
                  <input  type={newPasswordVisible ? 'text' : 'password'} name="password" placeholder="Password" className={customstyles.inputsection} value={newPassword} onChange={(e) => {setNewPassword(e.target.value);setErrorMessage(''); }}/>
              ...
              <div className={styles.inputform1} style={{ marginBottom:'50px' }}>
                  ...
                  <img src="/pass.svg" alt="" className={customstyles.icon}/>
                  <input  type={confirmNewPasswordVisible ? 'text' : 'password'} name="password" placeholder="Password" className={customstyles.inputsection} value={confirmNewPassword} onChange={(e) => {setConfirmNewPassword(e.target.value);setErrorMessage('');}}/>
          ...
          <div className={styles.btngroup}>
              <Button className={styles.passbtn} onClick={handleSaveChangePassword}>SAVE</Button>
